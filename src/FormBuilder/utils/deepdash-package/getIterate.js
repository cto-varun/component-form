    ...
    function getElements(
        ...
        for (var i = 0; i < children.length; i++) {
            ...
            res.push({
                ...
                childrenPath:
                    (childrenPath.length && childrenPath) || undefined,
...
var prototypeAccessors = {
    ...
    parents: { configurable: true },
    depth: { configurable: true },
    isLeaf: { configurable: true },
    isCircular: { configurable: true },
    circularParentIndex: { configurable: true },
    circularParent: { configurable: true },
    childrenPath: { configurable: true },
