  ...
  properties: {
          ...
          additionalProperties: {
            ...
            properties: {
              type: {
                ...
                type: 'string',
                enum: ['identity', 'linear', 'cat', 'time', 'timeCat', 'log', 'pow']
              },
              alias: {
                title: 'Field name, that is displayed in legend, tooltip and axis',
                type: 'string'
              },
              range: {
    ...
    stack: {
      ...
      properties: {
        ...
        type: {
          title: 'Stacking type',
          type: 'string',
          enum: ['fill-rows', 'impute', 'fold', 'percent', 'bin.histogram', 'bin.hexagon', 'bin.rectangle']
        },
        fields: {
    ...
    geometry: {
      ...
      properties: {
        types: {
          ...
          items: {
            type: 'string',
            enum: ['point', 'line', 'area', 'interval', 'polygon', 'edge', 'schema', 'contour', 'heatmap', 'intervalStack']
          },
        ...
        color: {
          ...
          example: ['location', ['#ffd54f', '#ef6c00', '#1976d2', '#64b5f6']]
        },
        shape: {
          title: 'Method of mapping data values to the shape of a graphic',
          type: ['string', 'array']
        },
        opacity: {
    ...
    label: {
      ...
      properties: {
        ...
        content: {
          title: 'Specify the text content displayed on the label, either the data latitude or custom',
          type: 'string'
        }
      }
    },
    ...
    legend: {
      ...
      properties: {
        ...
        marker: {
          ...
          type: 'string',
          enum: ['circle', 'square', 'bowtie', 'diamond', 'hexagon', 'triangle', 'triangle-down', 'hollowCircle', 'hollowSquare', 'hollowBowtie', 'hollowDiamond', 'hollowHexagon', 'hollowTriangle', 'hollowTriangle-down', 'cross', 'tick', 'plus', 'hyphen', 'line']
        },
        clickable: {
